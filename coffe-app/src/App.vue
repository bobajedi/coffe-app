...
<template>
  <div class="app-container">
    <header class="navbar">
      <h1 style="color: white;">Coffee Shop</h1>
        <div  class="navbar-menubar">
          <span class="menubar-p">Menu</span>
          <span class="menubar-p">Menu</span>
          <span class="menubar-p">Menu</span>
          <span class="menubar-p">Menu</span>
          <span class="menubar-p">Menu</span>
        </div>
      <div style="color: white; font-size: 25px;" class="cart-summary">Shporta: {{ cart.length }}</div>
    </header>
